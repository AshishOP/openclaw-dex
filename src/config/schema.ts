...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.enabled": "Enable the web_search tool (requires a provider API key, except for DDGS which is free).",
  "tools.web.search.provider": 'Search provider ("brave", "perplexity", or "ddgs"). DDGS is free and requires no API key.',
